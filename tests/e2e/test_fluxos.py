def test_criar_pedido(api_client, cliente_teste, itens_teste):
    ...
    response = api_client.post(
        "/pedidos/", {"cliente": cliente_data, "itens": itens_data}, format="json"
    )
...
def test_listar_pedidos(api_client, pedido_repo_mock, pedido_teste):
    pedido_repo_mock.salvar(pedido_teste)
...
def test_buscar_pedido_por_id(api_client, pedido_repo_mock, pedido_teste):
    pedido_repo_mock.salvar(pedido_teste)
